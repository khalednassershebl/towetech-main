...
$(document).ready(function () {
  ...
  function animateSlideContent(slide) {
    ...
    function resetAndAnimate(element) {
      ...
      const animationClasses = allClasses.filter(cls => 
        cls === 'fadeIn' || cls === 'fadeInUp' || cls === 'fadeInDown' ||
        cls === 'fadeInLeft' || cls === 'fadeInRight' ||
        cls === 'zoomIn' || cls === 'bounceIn' || cls === 'pulse' ||
        cls === 'slideInUp' || cls === 'slideInDown' || cls === 'slideInLeft' || cls === 'slideInRight'
      );
      
      const animationClass = animationClasses.length > 0 ? animationClasses[0] : 'fadeInUp';
      ...
      element.classList.remove("wow", "animated", "fadeIn", "fadeInUp", "fadeInLeft", "fadeInRight", 
        "fadeInDown", "zoomIn", "bounceIn", "pulse", "slideInUp", "slideInDown", 

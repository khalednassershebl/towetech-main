...
<body>
    ...
    <div class="content">
        ...
        <div class="index-header" id="home" @if(isset($sliders) && $sliders->count() > 0 && $sliders->first()->background) style="background-image: url('{{ asset('storage/' . $sliders->first()->background) }}');" @endif>
            <div class="container">
                ...
                <div class="index-header-content">
                    <div class="index-header-content-details">
                        ...
                        <div class="header-bottom-info wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <a class="header-btn" href="{{ (isset($sliders) && $sliders->count() > 0 && $sliders->first()->link) ? $sliders->first()->link : url('/services') }}">
                        ...
                        @if(isset($partners) && $partners->count() > 0)
                            @foreach($partners as $partner)
                                <div class="partners-slider-item">
                                    @if($partner->logo)
                                        <img src="{{ asset('storage/' . $partner->logo) }}" alt="{{ $partner->name_ar }}">
                                    @else
                ...
                <div class="row">
                            ...
                            <div class="num-card">
                                <div class="num-card-head">
                                    <div class="num-card-header-info">
                                        ...
                                        @if(isset($about) && $about->experience_image)
                                            <img src="{{ asset('storage/' . $about->experience_image) }}" alt="">
                                        @else
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="about-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <a class="header-btn" href="{{ url('/about') }}"><span>{{ ($locale ?? 'ar') == 'en' ? 'Learn More' : 'اعرف المزيد عنا' }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M10.8284 12.0007L15.7782 16.9504L14.364 18.3646L8 12.0007L14.364 5.63672L15.7782 7.05093L10.8284 12.0007Z"></path>
                                </svg>
                            </a>
                    ...
                    @if(isset($heroSlides) && $heroSlides->count() > 0)
                        @foreach($heroSlides as $index => $heroSlide)
                            <div class="hero-slide {{ $index === 0 ? 'active' : '' }}" 
                                 style="background-image: url('{{ $heroSlide->background_image ? asset('storage/' . $heroSlide->background_image) : asset('Tower Tech Front/assets/images/projects/01.png') }}');">
                                    ...
                                    <div class="service-card-tilt wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="{{ 0.1 + ($index * 0.1) }}s">
                                        <div class="service-card">
                                            <div class="service-icon">
                                                @if($service->image)
                                                    <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->title_ar }}">
                                                @else
                                            ...
                                            <div class="review-card-head">
                                                <figure>
                                                    @if($testimonial->image)
                                                        <img src="{{ asset('storage/' . $testimonial->image) }}" alt="{{ $testimonial->name_ar }}">
                                                    @else
                            ...
                            @foreach($blogs as $index => $blog)
                                <div class="col-lg-4 col-md-6">
                                    <a href="{{ $blog->link ? $blog->link : url('/blogs') }}" class="blog-card-tilt wow fadeInUp" data-wow-duration="0.8s"
                                        ...
                                        <div class="blog-card">
                                            <figure style="background-image: url('{{ $blog->image ? asset('storage/' . $blog->image) : 'https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=800&h=600&fit=crop&q=80' }}')">
                                                <div class="blog-date">

...
$activeMenu = 'blogs';
} elseif (str_contains($currentRoute, 'admin.categories')) {
...
if (!$activeSubmenu && $activeMenu === 'categories') {
if (str_contains($currentRoute, 'create')) {
$activeSubmenu = 'categories.create';
} elseif (str_contains($currentRoute, 'index') || str_contains($currentRoute, 'edit') || str_contains($currentRoute, 'show')) {
$activeSubmenu = 'categories.index';
}
}
...
// Submenu
if (!$activeSubmenu && $activeMenu === 'products') {
if (str_contains($currentRoute, 'create')) {
$activeSubmenu = 'products.create';
} elseif (str_contains($currentRoute, 'index') || str_contains($currentRoute, 'edit') || str_contains($currentRoute, 'show')) {
$activeSubmenu = 'products.index';
}
}
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <div class="menu-item-with-submenu {{ $activeMenu === 'categories' ? 'open' : '' }}">
            <div class="menu-item" onclick="toggleSubmenu(this)">
                <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M6.5 6.5V4.5H20.5V6.5H6.5ZM6.5 12.5V10.5H20.5V12.5H6.5ZM6.5 18.5V16.5H20.5V18.5H6.5ZM3.5 7C2.67157 7 2 6.32843 2 5.5C2 4.67157 2.67157 4 3.5 4C4.32843 4 5 4.67157 5 5.5C5 6.32843 4.32843 7 3.5 7ZM3.5 13C2.67157 13 2 12.3284 2 11.5C2 10.6716 2.67157 10 3.5 10C4.32843 10 5 10.6716 5 11.5C5 12.3284 4.32843 13 3.5 13ZM3.5 19C2.67157 19 2 18.3284 2 17.5C2 16.6716 2.67157 16 3.5 16C4.32843 16 5 16.6716 5 17.5C5 18.3284 4.32843 19 3.5 19Z"></path>
                    </svg></i>
                <span>الأقسام</span>
                <span class="menu-arrow"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M11.9999 13.1714L16.9497 8.22168L18.3639 9.63589L11.9999 15.9999L5.63599 9.63589L7.0502 8.22168L11.9999 13.1714Z"></path>
                    </svg></span>
            </div>
            <div class="submenu">
                <a href="{{ route('admin.categories.index') }}" class="submenu-item {{ $activeSubmenu === 'categories.index' ? 'active' : '' }}">عرض الجميع</a>
                <a href="{{ route('admin.categories.create') }}" class="submenu-item {{ $activeSubmenu === 'categories.create' ? 'active' : '' }}">انشاء جديد</a>
            </div>
        </div>
        ...
        <div class="menu-item-with-submenu {{ $activeMenu === 'section-headers' ? 'open' : '' }}">
            <div class="menu-item" onclick="toggleSubmenu(this)">
                <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19 11V5H5V11H19ZM19 13H5V19H19V13ZM4 3H20C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3Z"></path>
                    </svg></i>
        ...
        <div class="menu-item-with-submenu {{ $activeMenu === 'products' ? 'open' : '' }}">
            <div class="menu-item" onclick="toggleSubmenu(this)">
                <i>
                    <!-- ممكن تضعي أي أيقونة مناسبة للمنتجات -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M4 4H20V20H4V4ZM6 6V18H18V6H6Z"></path>
                    </svg>
                </i>
                <span>المنتجات</span>
            ...
            <div class="submenu">
                <a href="{{ route('admin.items.show') }}" class="submenu-item {{ $activeSubmenu === 'products.index' ? 'active' : '' }}">عرض المنتجات</a>
                <a href="{{ route('admin.items.create') }}" class="submenu-item {{ $activeSubmenu === 'products.create' ? 'active' : '' }}">
                    اضافة منتج جديد
                </a>
            </div>
        </div>

...
@section('page-title', 'إضافة رأي عميل جديد')
    ...
    <div class="card">
        <form action="{{ route('testimonials.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" id="rating" name="rating" value="{{ old('rating', 5) }}" min="1" max="5" required>
            ...
            <div class="lang-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="position_ar" name="position_ar" value="{{ old('position_ar') }}" required>
                    @error('position_ar')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="review_ar" name="review_ar" required>{{ old('review_ar') }}</textarea>
                    @error('review_ar')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="lang-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="position_en" name="position_en" value="{{ old('position_en') }}" required>
                    @error('position_en')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="review_en" name="review_en" required>{{ old('review_en') }}</textarea>
                    @error('review_en')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn-primary">حفظ الرأي</button>

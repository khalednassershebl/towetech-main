    ...
    <div class="card">
        <form action="{{ route('hero-slides.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="link" name="link" value="{{ old('link') }}" placeholder="https://example.com أو /services">
                ...
                <div id="tab-arabic" class="tab-content active">
                    <div class="lang-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="subtitle_ar" name="subtitle_ar" rows="4">{{ old('subtitle_ar') }}</textarea>
                            @error('subtitle_ar')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div id="tab-english" class="tab-content">
                    <div class="lang-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="subtitle_en" name="subtitle_en" rows="4">{{ old('subtitle_en') }}</textarea>
                            @error('subtitle_en')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn-primary">حفظ الشريحة</button>
